...
app.Use(cors.New(cors.Config{
    ...
    app.Get("/users/:id", validateLogin)
...
func validateLogin(c *fiber.Ctx){
    
}
func login(c *fiber.Ctx) error {
    var users []models    type Credentials struct {
    ...
    expectedPassword, ok := db.First(&users,creds.Username)/*pick from sql*/
