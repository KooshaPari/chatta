...
fmt.Println("Hash version:", hashInfo.Version)
fmt.Println("Hash cost:", hashInfo.Cost)fmt.Println("Users Pass:", creds.Password)
    hashInfo := bcrypt.(users.Password)
fmt.Println("Hash salt:", hashInfo.Salt)
} else {
