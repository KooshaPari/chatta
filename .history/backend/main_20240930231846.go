...
app.Use(cors.New(cors.Config{
    ...
    app.Get("/ws", websocket.New(func(c *websocket.Conn) {
        ...
        incomingMsg.SenderID = userUUID              // Assuming you have the sender's UUID
        incomingMsg.Sender = currentUser              // Assuming you have the current user object
