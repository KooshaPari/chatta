...
<Modal isOpen={showEditModal} on:close={closeEditModal}>
	...
	<input bind:value={selectedMessage.Content} placeholder="Type a message..." />
	<button on:click={editMessage}>editBtn</button>
</Modal>
<div class="chat-window">
	{#each messages as msg}
		<div class="message">
			{msg.sender.username}: {msg.content}
			<button on:click={openEditModal} class="editBtn"
