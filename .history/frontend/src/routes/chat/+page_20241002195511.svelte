...
<div class="chattaApp">
	...
	<div class="chattaSidebar">
		<ul class="chattaNav">
			...
			<li>Chats<ul class="chattaChats"></ul></li>
			<!--Collapsible DMs List-->
			<li>DMs<ul class="chattaDMs"></ul></li>
			<!--Collapsible Settings-->
			<li>Settings--<ul class="chattaStgsCollapsible"></ul></li>
			<!--Sign Out -->
			<button on:click={signOut} class="signOutBtn"></button>
		</ul>
	</div>
</div>
