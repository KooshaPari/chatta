		...
		<menu class="chattaNav">
			...
			<li>
				...
				<ul class="chattaChats">
					{#each chats as chat}
						{#if chat.type == "thread"}
							<li class="chatPill">{chat.name}</li>
						{/if}
					{/each}-
				</ul>
			</li>
...
<style>
	...
	.chattaNav{
		eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJUZXN0ZXIiLCJleHAiOjE3MjgyODMzMjd9.i2VwUP9ZtffL7cAgS7Q6mUcQsGbcmEpuiS-nndlpGyg
	}
</style>
